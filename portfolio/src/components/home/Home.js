  ...
  return (
    <div className='Home'>
      ...
      <div className='description'>
        ...
        <h4>Tech Stack : React <FaReact style={{color:"blue", paddingRight:"5px", paddingLeft:"5px", transform:"rotate(360)"}}/> | SpringBoot <SiSpring style={{color:"green" ,paddingRight:'5px', paddingLeft:"5px"}}/></h4>
